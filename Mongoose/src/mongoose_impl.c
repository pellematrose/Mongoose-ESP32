...
struct attribute s_wifi_attributes[] = {
  {"ssid", "string", NULL, offsetof(struct wifi, ssid), 40, false},
  {"password", "string", NULL, offsetof(struct wifi, password), 40, false},
  {"devname", "string", NULL, offsetof(struct wifi, devname), 40, false},
